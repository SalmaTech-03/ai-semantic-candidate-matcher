...
# --- Backend Functions ---
def extract_text(file_uploader_object):
    text = ""
...
def generate_ai_summary(resume_text, jd_text):
    ...
    prompt = f"""Analyze this resume in context of the job description. Provide a 3-sentence professional summary.
    ...
    if uploaded_files and job_description:
        with st.spinner("Analyzing resumes..."):
            ...
            for file in uploaded_files:
                ...
                analysis = analyze_resume(resume_text, job_description, jd_skills, jd_embedding)
            ...
            st.dataframe(df[['filename','match_score','matching_skill_count','missing_skill_count','ai_summary']], use_container_width=True)
